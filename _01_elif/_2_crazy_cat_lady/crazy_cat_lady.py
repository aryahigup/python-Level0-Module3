...
if __name__ == '__main__':
    ...
    num = simpledialog.askinteger(title='Crazy Cat Lady', prompt='How many cats do you have?')
    #      4) If they have 3 or more cats, tell them they are a crazy cat lady
    if num >= 3:
        messagebox.showinfo(title='Crazy Cat Lady', message='You are a crazy cat lady')
